...
class  StudentDriver
{
	public static void main (String[] args)
	{
		...
		System.out.println(stud1.getName() + "의 총점은 " + stud1.getTotal() + "이고 학점은 " + stud1.getGrade() + "이다.");
		...
		// 두 번째 학생의 이름, 총점과 학점을 출력한다
  			// 여기에 코드를 삽입하세요
		System.out.println(stud2.getName() + "의 총점은 " + stud2.getTotal() + "이고 학점은 " + stud2.getGrade() + "이다.");
   }
}